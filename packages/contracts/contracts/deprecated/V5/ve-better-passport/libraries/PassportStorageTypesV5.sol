 ...
 */
library PassportStorageTypesV5 {
  struct PassportStorage {
    ...
    mapping(PassportTypesV5.APP_SECURITY security => uint256 multiplier) securityMultiplier;
    // Security level of an app -> will be UNDEFINED and set to LOW by default
    mapping(bytes32 appId => PassportTypesV5.APP_SECURITY security) appSecurity;
