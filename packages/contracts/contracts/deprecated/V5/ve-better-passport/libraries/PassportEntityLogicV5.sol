...
library PassportEntityLogicV5 {
  ...
  // ---------- Constants ---------- //
  string private constant SIGNING_DOMAIN = "VeBetterPassportV5";
  ...
  function linkEntityToPassportWithSignature(
    ...
    bytes32 digest = PassportEIP712SigningLogicV5.hashTypedDataV4(structHash);
  ...
  function _pushCheckpoint(Checkpoints.Trace160 storage store, address value) private {
    store.push(PassportClockLogicV5.clock(), uint160(value));
  }
  ...
  function _removeEntityLink(
    ...
    PassportSignalingLogicV5.removeEntitySignalsFromPassport(entity, passport);
    PassportWhitelistAndBlacklistLogicV5.removeEntitiesBlackAndWhiteListsFromPassport(entity, passport);
  }
  ...
  function _linkEntity(address entity, address passport) private {
    ...
    PassportSignalingLogicV5.attachEntitySignalsToPassport(entity, passport);
    PassportWhitelistAndBlacklistLogicV5.attachEntitiesBlackAndWhiteListsToPassport(entity, passport);
  ...
  function _checkLink(
    ...
    if (
      PassportDelegationLogicV5.isDelegator(entity) ||
    ...
    if (PassportDelegationLogicV5.isDelegatee(entity) || self.pendingDelegationsDelegateeToDelegators[entity].length != 0) {
      revert DelegatedEntity(entity);
    }
