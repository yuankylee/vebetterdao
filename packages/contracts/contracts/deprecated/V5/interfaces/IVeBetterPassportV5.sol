...
import { PassportTypesV5 } from "../ve-better-passport/libraries/PassportTypesV5.sol";
...
interface IVeBetterPassportV5 {
  ...
  function initialize(
    PassportTypesV5.InitializationData calldata data,
    PassportTypesV5.InitializationRoleData calldata roles
  ) external;
  ...
  function toggleCheck(PassportTypesV5.CheckType check) external;
