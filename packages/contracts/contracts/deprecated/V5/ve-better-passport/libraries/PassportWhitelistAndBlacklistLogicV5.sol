...
/**
 * @title PassportWhitelistAndBlacklistLogicV5
 ...
 */
library PassportWhitelistAndBlacklistLogicV5 {
  // ---------- Events ---------- //
  ...
  function _isPassportWhitelisted(
    ...
    PassportStorageTypesV5.PassportStorage storage self = PassportStorageTypesV5.getPassportStorage();
    passport = PassportEntityLogicV5._getPassportForEntity(passport);
    ...
    uint256 totalEntities = PassportEntityLogicV5.getEntitiesLinkedToPassport(passport).length;
